...
WebUI.callTestCase(findTestCase('APITestsPizzaOrder/TC002CreatePizzaOrder'), [:], FailureHandling.STOP_ON_FAILURE)

def authToken = CustomKeywords.'common.getAuthorisationToken.GetAuthorisationToken'()

RequestObject ScopeToProject = findTestObject('PizzaAppAPI/deletePizzaOrder')
...
assertThat(parsedJson.message == 'Order deleted').isEqualTo(true)
