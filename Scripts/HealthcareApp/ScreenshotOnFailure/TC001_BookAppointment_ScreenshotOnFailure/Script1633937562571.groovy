...
WebUI.takeElementScreenshotAsCheckpoint('Screenshot Of Confirmation', findTestObject('HealthCareDemo/AppointmentPage/h2_Appointment Confirmation'))

WebUI.delay(2)

WebUI.verifyElementNotPresent(findTestObject('HealthCareDemo/AppointmentPage/h2_Appointment Confirmation'), 0)
